		...
		else
		{
			...
			if(isset($_POST['accion']) )
			{
				...
				if($_POST['accion'] == 'editar')
				{
					...
					if($user->editar($n, $p))
						aviso("success", $n." foi actualizado correctamente.", "usuarios.php", "Voltar &aacute; lista de usuarios");
					else
						aviso("danger", "Houbo alg&uacute;n problema durante a modificaci&oacute;n do perfil", "usuarios.php", "Voltar &aacute; lista de usuarios");
				}
				else
				{
					erro("Houbo alg&uacute;n erro ao intentar recuperar o usuario solicitado.");
			...
			<div class="jumbotron">
				...
				if($usuarioActual->admin())
				{
					...
					if($id != $_SESSION['ID'])
					{
						echo'
						    <div class="col-sm-2">
						    	<a href="eliminarusuario.php?id='.$id.'" class="btn btn-danger"><span class="glyphicon glyphicon-remove-sign"></span> Eliminar Usuario</a>
						    </div>
					    ';
					    if($user->admin())
					    	echo '				    
							    <div class="col-sm-2">
							    	<a href="quitaradmin.php?id='.$id.'" class="btn btn-default"><span class="glyphicon glyphicon-minus-sign"></span> Quitar administrador</a>
							    </div>
							';
						else
							echo '				    
							    <div class="col-sm-2">
							    	<a href="daradmin.php?id='.$id.'" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> Facer administrador</a>
							    </div>
							';
					}
					echo '</fieldset>';
