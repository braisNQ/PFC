	...
	<div class="panel panel-default">
		...
		<div id="collapseForm" class="panel-collapse collapse">
  			<div class="panel-body">
				<form class="form-horizontal" role="form" id="formFiltro" action="usuarios.php" method="post">
					...
					<div class="form-group">
				    	...
				    	<div class="col-sm-offset-1 col-sm-3">
				     		...
				     		<a href="usuarios.php" class="btn btn-default btn-sm"><span class='glyphicon glyphicon-trash'></span> Limpar</a>
				    	</div>
				  	</div>
				</form>
  			</div>
