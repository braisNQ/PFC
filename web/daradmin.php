	...
	else
	{
		...
		{		
			...
			if(isset($_POST['accion']))
			{
				...
				{
					if($user->darAdmin())
						aviso("success", "O usuario ".$user->getNome()." xa &eacute; administrador.", "usuarios.php", "Voltar &aacute; lista de usuarios");
					else
			...
			{
				echo '
					<form class="form-horizontal" role="form" id="formDarAdmin" action="daradmin.php" method="post">
