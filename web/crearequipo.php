...
<!--
    ...
    <div class="container">
     ...
     <?php
		...
		{
			aviso("danger", "Ups! non deberías estar aqu&iacute;.", "equipos.php", "Voltar &aacute; lista de equipos");
		}
		else
		{
			//se non ten equipo
			if(!$usuarioActual->getIDequipo())
			{
					...
					if($_POST['accion'] == 'crear')
					{
						...
						if(!$bd->existeEquipo($_POST['nome']))
						{
							...
							if($bd->crearEquipo($_SESSION['ID'], $_POST['nome'], $_POST['codigo']))
							{
								...
								{
									aviso("success", "O equipo ".$_POST['nome']." foi creado con &eacute;xito.", "equipo.php", "Ver equipo");
								}
								//se falla ao modificar
								else
								{
									aviso("danger", "Houbo erros durante a creaci&oacute;n do equipo.", "equipos.php", "Ir &aacute; lista de equipos");
								}
							}
							//se creou mal
							else
							{
								aviso("danger", "Houbo un erro na creaci&oacute;n do equipo.", "crearequipo.php", "Voltar intentalo");
							}
						}
						else
						{
							aviso("danger", "Xa existe un equipo con nome ".$_POST['nome'].".", "crearequipo.php", "Voltar intentalo");
						}
					}
					//outro botón
					else
				...
				{
				?>
					<form class="form-horizontal" role="form" id="formCrearEquipo" action="crearequipo.php" method="post">
